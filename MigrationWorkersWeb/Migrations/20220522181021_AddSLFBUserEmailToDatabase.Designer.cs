...
namespace MigrationWorkersWeb.Migrations
{
    ...
    [Migration("20220522181021_AddSLFBUserEmailToDatabase")]
    partial class AddSLFBUserEmailToDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MigrationWorkersWeb.Models.Agency_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MigrationWorkersWeb.Models.Agency_User_Email", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MigrationWorkersWeb.Models.SLFB_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SLFB_Users");
                });

            modelBuilder.Entity("MigrationWorkersWeb.Models.SLFB_User_Email", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SLFBUserID")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SLFBUserID");

                    b.ToTable("SLFB_User_Emails");
                });
            ...
            modelBuilder.Entity("MigrationWorkersWeb.Models.Agency_User_Email", b =>
                {
                    b.HasOne("MigrationWorkersWeb.Models.Agency_User", "AgencyUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MigrationWorkersWeb.Models.SLFB_User_Email", b =>
                {
                    b.HasOne("MigrationWorkersWeb.Models.SLFB_User", "SLFB_User")
                        .WithMany()
                        .HasForeignKey("SLFBUserID");

                    b.Navigation("SLFB_User");
                });
